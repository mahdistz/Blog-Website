...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'blog_post.context_processors.most_liked_posts_context_processor',
                'blog_post.context_processors.most_visited_posts_context_processor',
            ],
        },
    },
]
...
AUTH_USER_MODEL = 'blog_post.User'
